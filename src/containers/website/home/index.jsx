...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <p className="text-xl text-secondary leading-relaxed max-w-xl">
                  ...
                  advanced AI. From plot development to character creation,
                  experience the future of storytelling with lightning-fast
                  generation and unlimited creativity.
                </p>
              </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm opacity-90 font-medium">
                        AI Story Generator Active
                      </span>
                    </div>
                    <div className="text-xs opacity-70 bg-white/10 px-3 py-1 rounded-full">
                      v2.0
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-white/15 rounded-xl p-6 backdrop-blur-sm">
                      ...
                      <p className="font-semibold text-lg">
                        "A time traveler discovers their actions changed
                        history..."
                      </p>
                    </div>
                    ...
                    <div className="bg-white/15 rounded-xl p-6 backdrop-blur-sm">
                      ...
                      <p className="font-medium leading-relaxed text-base">
                        Dr. Elena Vasquez stepped out of the temporal pod into
                        what should have been 2024 New York, but the skyline was
                        wrong. Floating gardens cascaded between crystalline
                        towers, and the air hummed with an energy she'd never
                        felt...
                      </p>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="space-y-3">
              <div className="text-4xl font-bold bg-gradient bg-clip-text text-transparent">
                1M+
              </div>
      ...
      <section
        id="how-it-works"
        className="py-24 bg-gradient-to-br from-gray-50 to-purple-50/20"
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-secondary max-w-3xl mx-auto leading-relaxed">
              Our advanced AI transforms your creative spark into compelling
              narratives through a simple three-step process
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Share your story concept, character, or plot idea. Our AI
                understands context, genre, and creative intent to build upon
                your vision.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Our neural networks analyze millions of story patterns,
                character archetypes, and narrative structures to craft your
                unique tale.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Receive a complete, engaging narrative with rich characters,
                compelling plot, and authentic dialogue ready to captivate your
                audience.
              </p>
            </div>
          </div>
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-secondary max-w-3xl mx-auto leading-relaxed">
              Advanced capabilities designed for writers, creators, and
              storytellers who demand excellence
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Advanced AI creates multi-layered plots with perfect pacing,
                compelling conflicts, and satisfying resolutions that keep
                readers engaged.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Generate complex characters with unique personalities, realistic
                motivations, and authentic dialogue that brings your stories to
                life.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Create immersive settings and rich environments that serve as
                the perfect backdrop for your narrative adventures.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Generate complete stories in under 3 seconds. Perfect for
                overcoming writer's block or meeting tight deadlines.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                From sci-fi epics to romantic comedies, our AI understands genre
                conventions and creates authentic stories in any style.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
              ...
              <p className="text-secondary leading-relaxed text-lg">
                Customize tone, complexity, and writing style to match your
                vision. From children's tales to literary masterpieces.
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        id="examples"
        className="py-24 bg-gradient-to-br from-purple-50/30 to-pink-50/30"
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold text-primary mb-6">
            ...
            <p className="text-xl text-secondary max-w-3xl mx-auto leading-relaxed">
              See the quality and creativity of AI-generated stories across
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              ...
              <p className="text-secondary leading-relaxed text-lg mb-6">
                "Commander Sarah Chen's hands trembled as she decoded the final
                transmission from Earth. The message was impossible—it had been
                sent from a future that no longer existed. As the space
                station's AI began to malfunction, displaying memories that
                weren't its own, Sarah realized the signal wasn't just a warning
                about humanity's fate. It was a key to changing it, hidden in
                the quantum echoes of a timeline that had been erased..."
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              ...
              <p className="text-secondary leading-relaxed text-lg mb-6">
                "Elara had always known her father's maps were special, but she
                never imagined they were doorways. When the parchment began to
                glow under the full moon, revealing paths that led beyond the
                edges of the known world, she understood why the Shadow Guild
                had been hunting her family for generations. Each map wasn't
                just a guide to distant lands—it was a prison, holding back
                ancient evils that her bloodline had sworn to contain..."
              </p>
              <div className="flex items-center space-x-4 text-sm text-secondary">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-secondary max-w-3xl mx-auto leading-relaxed">
              ...
              creative process with StoryWave
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="bg-gradient-to-br from-white to-purple-50/30 rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-secondary leading-relaxed text-lg mb-6">
                "StoryWave has revolutionized my writing process. I can generate
                compelling story outlines in seconds and focus on what I love
                most—developing characters and refining prose."
              </p>
            ...
            <div className="bg-gradient-to-br from-white to-pink-50/30 rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-secondary leading-relaxed text-lg mb-6">
                "As a content creator, I need fresh stories constantly. This AI
                doesn't just generate text—it creates engaging narratives that
                my audience loves. Game-changer!"
              </p>
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-gradient rounded-full flex items-center justify-center">
            ...
            <div className="bg-gradient-to-br from-white to-orange-50/30 rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-secondary leading-relaxed text-lg mb-6">
                "I was skeptical about AI writing, but StoryGen creates stories
                with genuine emotion and compelling characters. It's like having
                a creative partner who never runs out of ideas."
              </p>
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-gradient rounded-full flex items-center justify-center">
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-secondary max-w-3xl mx-auto leading-relaxed">
              Choose the perfect plan for your creative needs. All plans include
              unlimited revisions and export options.
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300">
              <div className="text-center mb-8">
                ...
                <p className="text-secondary">
                  Perfect for trying out AI storytelling
                </p>
              </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white">
                ...
                <p className="text-xl max-w-3xl mx-auto leading-relaxed opacity-90">
                  Join over 50,000 writers who are already using StoryWave to
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-5 gap-12">
            <div className="md:col-span-2 space-y-6">
              ...
              <p className="text-secondary leading-relaxed text-lg max-w-md">
                The most advanced AI story generator for writers, creators, and
                storytellers. Transform your ideas into compelling narratives in
                seconds.
              </p>
          ...
          <div className="border-t border-gray-200 mt-16 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-secondary font-medium">
                © 2024 StoryWave. All rights reserved.
              </p>
